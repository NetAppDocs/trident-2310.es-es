...
El tamaño de bloque y el ancho de banda influyen directamente en el número de IOPS. A medida que aumenta el tamaño de los bloques, el sistema incrementa el ancho de banda hasta el nivel necesario para procesar esos bloques más grandes. A medida que aumenta el ancho de banda, disminuye el número de IOPS que el sistema es capaz de alcanzar. Consulta https://www.netapp.com/pdf.html?item=/media/10502-tr-4644.pdf["Calidad de servicio de SolidFire"^] para obtener más información sobre QoS y el rendimiento.
...
* https://www.netapp.com/pdf.html?item=/media/10507-tr4639.pdf["Configuración de SolidFire para Linux"^]
...
* https://www.netapp.com/pdf.html?item=/media/10512-tr-4610.pdf["Prácticas recomendadas de PostgreSQL en SolidFire"^]
