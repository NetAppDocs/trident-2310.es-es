...
Para obtener información sobre FlexGroups y las cargas de trabajo adecuadas para FlexGroups, consulta https://www.netapp.com/pdf.html?item=/media/12385-tr4571.pdf["Prácticas recomendadas y guía de implementación de los volúmenes FlexGroup de NetApp"^].
