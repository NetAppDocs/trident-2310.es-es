...
Una de las muchas link:../trident-install/kubernetes-deploy.html["Ventajas del uso del operador Trident"] ventajas de instalar y actualizar Astra Trident es la gestión automática de los objetos de Astra Trident y Kubernetes sin afectar a los volúmenes montados existentes. De este modo, Astra Trident permite realizar actualizaciones sin tiempo de inactividad, o link:https://kubernetes.io/docs/tutorials/kubernetes-basics/update/update-intro/["_actualizaciones sucesivas_"^]. En concreto, el operador de Trident se comunica con el clúster de Kubernetes para:
...
TIP: Para obtener más información sobre la arquitectura de Astra Trident en el clúster de Kubernetes, consulta link:../trident-get-started/architecture.html["Arquitectura de Astra Trident"].
