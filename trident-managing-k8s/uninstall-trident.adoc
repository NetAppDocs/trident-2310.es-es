...
* Si necesitas una corrección de errores observados después de una actualización, problemas de dependencias o una actualización fallida o incompleta, debes desinstalar Astra Trident y reinstalar la versión anterior usando las instrucciones específicas para esa versión. Esta es la única forma recomendada de _downgrade_ a una versión anterior.
