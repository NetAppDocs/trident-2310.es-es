...
Usando la utilidad [`tridentctl`, puedes ejecutar el comando  `get` para obtener los volúmenes subordinados. Para más información, consulta link:../trident-managing-k8s/tridentctl.html[`tridentctl` comandos y opciones].
