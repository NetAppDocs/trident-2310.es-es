...
----
+
++ NOTA: después de ejecutar este comando, ONTAP solicita la introducción del certificado. Pega el contenido del  `k8senv.pem` archivo generado en el paso 1, luego introduce  `END` para completar la instalación.
