...
| `pod-security.kubernetes.io/enforce`
 ...
 `pod-security.kubernetes.io/enforce-version` | Permite admitir la controladora Trident y los nodos en el espacio de nombres de instalación.

No cambie la etiqueta de espacio de nombres. | `enforce: privileged`
