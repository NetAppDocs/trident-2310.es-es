...
.Antes de empezar
Antes de comenzar la instalación, inicia sesión en el host Linux y verifica que está gestionando un servidor en funcionamiento, link:../trident-get-started/requirements.html["Clúster de Kubernetes compatible"^] y que tienes los privilegios necesarios.
...
[%collapsible]
====
Para obtener más información sobre «force detach», consulta link:kubernetes-customize-deploy.html["Personalice la instalación del operador de Trident"].
